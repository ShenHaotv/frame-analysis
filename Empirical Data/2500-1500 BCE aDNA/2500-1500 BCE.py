...
"""To get the genotype file, please download the v62.0_1240k_public dataset from https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/FFIDCW, apply the filters we showed in the supplementary, delete the repeating samples (for this step, we suggest using 2500-1500 BCE_individual_list.csv), and do the mean value imputation """

"""For the coord, grid, edges file, please use 2500-1500 BCE.coord, 2500-1500 BCE_grid.csv and 2500-1500 BCE_edges.csv """
