...
"""To get the genotype file, please download the v62.0_1240k_public dataset from https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/FFIDCW, apply the filters we showed in the supplementary, delete the repeating samples (for this step, we suggest using 4500-3500 BCE_individual_list.csv), and do the mean value imputation """

"""For the coord, grid, edges file, please use 4500-3500 BCE.coord, 4500-3500 BCE_grid.csv and 4500-3500 BCE_edges.csv"""
...
fig, axs= plt.subplots(4, 2, figsize=(8,9), dpi=300,
...
v = Vis(axs[0,0], sp_digraph, projection=projection, edge_width=1,
        ...
        cbar_bbox_to_anchor=(0.2, 0.13),   
        compass_bbox_to_anchor=(0.15, 0.025),
        compass_font_size=5,
        compass_radius=0.15,
        mutation_scale=6)

v.digraph_wrapper_new(axs, node_scale=[5, 5, 5])
